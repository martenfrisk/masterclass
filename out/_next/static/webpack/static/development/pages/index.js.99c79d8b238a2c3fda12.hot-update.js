...
function Home() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, {
    ...
    className: "w-auto p-4 text-2xl text-white bg-red-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60,
