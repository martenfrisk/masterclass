...
function Home() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, {
    ...
    className: "w-3/4 mx-6 my-6 text-center bg-gray-300 rounded-lg shadow-lg h-76 md:my-0 md:w-2/5",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 151,
