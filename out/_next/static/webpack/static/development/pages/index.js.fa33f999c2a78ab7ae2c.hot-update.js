...
function Home() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, {
    ...
    className: "w-3/4 h-auto mx-10 my-6 text-center bg-gray-300 rounded-lg shadow-lg md:my-0 md:w-1/3",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 151,
