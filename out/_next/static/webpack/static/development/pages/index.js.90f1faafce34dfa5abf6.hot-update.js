...
function Home() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, {
    ...
    className: "flex flex-wrap items-center justify-center w-full h-auto pl-4 pr-8 text-left md:py-6",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 153,
    ...
    className: "self-end mb-4 italic text-center md:pt-10",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 171,
