...
function Home() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, {
    ...
    className: "w-auto p-4 mt-2 text-lg text-white bg-red-300 rounded-md",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60,
